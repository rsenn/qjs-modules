...
function AddECMAScriptDefines(lexer) {
  lexer.define('DecimalDigit', `[0-9]`);
  lexer.define('DecimalDigits', `[0-9]+`);
  lexer.define('NonZeroDigit', `[1-9]`);
  lexer.define('OctalDigit', `[0-7]`);
  lexer.define('HexDigit', `[0-9a-fA-F]`);
  lexer.define('UnicodeIdentifierStart',
  ...
  lexer.define('UnicodeIdentifierPart',
  ...
  lexer.define('IdentifierStart', `[$_a-zA-Z]|"\\\\"[u]{HexDigit}{4}`);
  //lexer.define("IdentifierStart", `{UnicodeIdentifierStart}|[$_a-zA-Z]|"\\\\"[u]{HexDigit}{4}`);
  lexer.define('IdentifierPart', `{IdentifierStart}|[0-9]`);
  //lexer.define("IdentifierPart", `{IdentifierStart}|{UnicodeIdentifierPart}|[0-9]`);
  lexer.define('Identifier', `({IdentifierStart})({IdentifierPart})*`);
  lexer.define('ExponentIndicator', `[eE]`);
  lexer.define('SignedInteger', `[+-]?[0-9]+`);
  lexer.define('DecimalIntegerLiteral', `[0]|{NonZeroDigit}{DecimalDigit}*`);
  lexer.define('ExponentPart', `{ExponentIndicator}{SignedInteger}`);
  lexer.define('OctalIntegerLiteral', `[0]{OctalDigit}+`);
  lexer.define('HexIntegerLiteral', `[0][xX]{HexDigit}+`);
  lexer.define('DecimalLiteral',
  ...
  lexer.define('RegularExpressionNonTerminator', `[^\\n\\r]`);
  lexer.define('RegularExpressionBackslashSequence', `\\\\{RegularExpressionNonTerminator}`);
  lexer.define('RegularExpressionClassChar',
    `[^\\n\\r\\]\\\\]|{RegularExpressionBackslashSequence}`
  );
  lexer.define('RegularExpressionClass', `\\[{RegularExpressionClassChar}*\\]`);
  lexer.define('RegularExpressionFlags', `({IdentifierPart})*`);
  lexer.define('RegularExpressionFirstChar',
    `([^\\n\\r\\*\\\\\\/\\[])|{RegularExpressionBackslashSequence}|{RegularExpressionClass}`
  );
  lexer.define('RegularExpressionChar',
    `([^\\n\\r\\\\\\/\\[]|{RegularExpressionBackslashSequence}|{RegularExpressionClass})`
  );
  lexer.define('RegularExpressionBody', `{RegularExpressionFirstChar}{RegularExpressionChar}*`);
  lexer.define('RegularExpressionLiteral', `\\/{RegularExpressionBody}\\/{RegularExpressionFlags}`);
