...
JSValue js_location_new_proto(JSContext*,
                              JSValue proto,
                              const Location* location);
JSValue js_location_new(JSContext*, const Location* location);
JSValue
js_location_tostring(JSContext*, JSValue this_val, int argc, JSValue* argv);
BOOL js_is_location(JSContext*, JSValue obj);
Location js_location_from(JSContext*, JSValue this_val);
JSValue
js_location_toprimitive(JSContext*, JSValue this_val, int argc, JSValue* argv);
JSValue js_location_constructor(JSContext*,
                                JSValue new_target,
                                int argc,
                                JSValue* argv);
