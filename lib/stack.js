...
const booleanProps = ['is', 'isEval', 'isNative', 'isToplevel'];
...
for(const method of ['slice', 'splice', 'indexOf', 'lastIndexOf', 'find', 'findIndex', 'findLastIndex', 'entries', 'values', 'filter', 'reverse', 'shift', 'unshift', 'push', 'pop'])
