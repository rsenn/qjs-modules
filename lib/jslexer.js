...
export const JSRules = [
  ...
  ['regexpLiteral', '<INITIAL,NESTED>{RegularExpressionLiteral}'],
  ...
  [
    ...
    (lex, skip) => {
      ...
      console.log(`stateStack 1`, lex.stateStack);
    }
  ],
  ['templateLiteral', /<TEMPLATE>{TemplateElement}*\${/, lex => lex.pushState('NESTED')],
  [
    'templateLiteral',
    ...
    lex => {
      try {
        lex.popState();
        console.log(`stateStack 2`, lex.stateStack);
      } catch(e) {}
    }
  ],
