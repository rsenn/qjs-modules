export class AsyncIterator {
  static from(iter, ...args) {
    ...
    if('next' in iterable && typeof iter.next == 'function') return iter;
...
export const AsyncIteratorConstructor = AsyncIterator;

Object.defineProperty(AsyncIterator.prototype, Symbol.toStringTag, {
  value: 'AsyncIterator',
});

export default () => (globalThis.AsyncIterator = AsyncIterator);
