...
export const FunctionExtensions = nonenumerable({
    ...
    if(isAsyncFunction(onRejected)) return AsyncFunctionExtensions.catch.call(this, onRejected);
  ...
  then(onFulfilled, onRejected) {
    if(isAsyncFunction(onRejected) || isAsyncFunction(onFulfilled)) return AsyncFunctionExtensions.then.call(this, onFulfilled, onRejected);
    ...
    if(isAsyncFunction(onFinally)) return AsyncFunctionExtensions.finally.call(this, onFinally);
