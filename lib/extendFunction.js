import { tryFunction, isFunction, types, define, nonenumerable } from './util.js';
...
export const FunctionExtensions = nonenumerable({
  ...
  then(onFulfilled, onRejected) {
    if(isAsyncFunction(onFulfilled) || isAsyncFunction(onRejected)) {
      return AsyncFunctionExtensions.then.call(this, onFulfilled, onRejected);
    }

    const self = this;

    return tryFunction(self, onFulfilled, onRejected);
