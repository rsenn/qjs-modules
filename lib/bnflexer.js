...
export class BNFLexer extends Lexer {
  ...
  addRules() {
    ...
    this.addRule('bracegroup', /{[^}]*}/, 0b11);

    this.addRule('ws', /[ \t\r\n]+/, 0b10000011);

    for(let name in CTokens) this.addRule(name, CTokens[name], 0b100);
  }
}
