...
export const ArrayExtensions = {
  ...
  pushUnique(...args) {
    return args.reduce(
      (acc, item) =>
        ArrayPrototype.indexOf.call(this, item) == -1 ? (ArrayPrototype.push.call(this, item), acc + 1) : acc,
      0
    );
  },
  unshiftUnique(...args) {
    return args.reduce(
      (acc, item) =>
        ArrayPrototype.indexOf.call(this, item) == -1 ? (ArrayPrototype.unshift.call(this, item), acc + 1) : acc,
      0
    );
  },
