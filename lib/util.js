...
export function defineGettersSetters(obj, gettersSetters, enumerable = false) {
  ...
  for(let name in gettersSetters) {
    props[name] = { get: gettersSetters[name], set: gettersSetters[name], enumerable };
  }
