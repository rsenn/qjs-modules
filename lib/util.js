...
/* prettier-ignore */ export const isInstanceOf = (c, o) => { if(Array.isArray(c)) return c.some(c => isInstanceOf(c, o)); if(isObject(c) && 'prototype' in c) try { if(Object.prototype.isPrototypeOf.call(c.prototype, o)); return true; } catch(e) {} try { if(o instanceof c) return true; } catch(e) {} };
