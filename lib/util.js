...
import { bits, dupArrayBuffer, escape, getpid, getPrototypeChain, getTypeName, isArray, isArrayBuffer, isBigInt, isBool, is, isFunction, isInteger, isNumber, isObject as isObject2, isString, isSymbol, rand, searchArrayBuffer, toString, } from 'misc';
...
export const TypedArray = getPrototypeOf(getPrototypeOf(new Uint16Array(10))).constructor;
...
export const types = {
  ...
  is: fn => isFunction(fn) && 'prototype' in fn,
