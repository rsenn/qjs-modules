...
import {JS_EVAL_FLAG_BACKTRACE_BARRIER, JS_EVAL_FLAG_COMPILE_ONLY, JS_EVAL_FLAG_STRICT, JS_EVAL_FLAG_STRIP, JS_EVAL_TYPE_DIRECT, JS_EVAL_TYPE_GLOBAL, JS_EVAL_TYPE_INDIRECT, JS_EVAL_TYPE_MASK, JS_EVAL_TYPE_MODULE, Location, arrayToBitfield, atob, atomToString, atomToValue, bitfieldToArray, btoa, compileScript, concat, dupArrayBuffer, error, escape, evalBinary, evalScript, fmemopen, fnmatch, getByteCode, getClassAtom, getClassConstructor, getClassCount, getClassID, getClassName, getClassProto, getCommandLine, getCurrentWorkingDirectory, getExecutable, getFileDescriptor, getOpCodes, getPerformanceCounter, getProcMaps, getProcMounts, getProcStat, getPrototypeChain, getRootDirectory, getegid, geteuid, getgid, getpid, getppid, getsid, getuid, glob, hrtime, isArray, isBigDecimal, isBigFloat, isBigInt, isBool, isCFunction, isConstructor, isEmptyString, isError, isException, isExtensible, isFunction, isHTMLDDA, isInstanceOf, isInteger, isJobPending, isLiveObject, isNull, isNumber, isObject, isRegisteredClass, isString, isSymbol, isUncatchableError, isUndefined, isUninitialized, isArrayBuffer, memcpy, quote, rand, randf, randi, readObject, resizeArrayBuffer, searchArrayBuffer, setegid, seteuid, setgid, setuid, srand, toArrayBuffer, toPointer, toString, uname, valuePtr, valueTag, valueToAtom, valueType, wordexp, writeObject } from 'misc';
