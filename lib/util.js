...
import { bits, dupArrayBuffer, escape, getpid, getPrototypeChain, getTypeName, isArray, isArrayBuffer, isBigInt, isBool, isConstructor, isFunction, isInteger, isNumber, isObject as isObject2, isString, isSymbol, rand, searchArrayBuffer, toString, } from 'misc';
...
export const isObject = o => o => typeof o == 'object' && o !== null;
export const requireObject = o => {
  if(!isObject(o)) throw new TypeError(`object required`);
  return o;
};
export const allObjects = (...args) => args.every(isObject);

/* prettier-ignore */ export const isInstanceOf = (ctor, o) => { if(Array.isArray(ctor)) return ctor.some(ctor => isInstanceOf(ctor, o)); if(isObject(ctor) && 'prototype' in ctor) try { if(Object.prototype.isPrototypeOf.call(ctor.prototype, o)); return true; } catch(e) {} try { if(o instanceof ctor) return true; } catch(e) {} };
export const isPrototypeOf = (proto, o) => isObject(o) && Object.prototype.isPrototypeOf.call(proto, o);
export const hasOwnProperty = (o, prop) => isObject(o) && Object.prototype.hasOwnProperty.call(o, prop);
export const hasProperty = (o, prop) => isObject(o) && prop in o;
export const propertyIsEnumerable = (o, prop) => isObject(o) && Object.prototype.propertyIsEnumerable.call(o, prop);
export const valueOf = (o, ...args) => isObject(o) && Object.prototype.valueOf.call(o, ...args);
export const toString = (o, ...args) => isObject(o) && Object.prototype.toString.call(o, ...args);
export const toLocaleString = (o, ...args) => isObject(o) && Object.prototype.toLocaleString.call(o, ...args);

export const getConstructorOf = o => requireObject(o) && (('constructor' in o && o.constructor) || ((o = getPrototypeOf(o)), 'constructor' in o && o.constructor));
export const getPrototypeOf = o => requireObject(o) && Object.getPrototypeOf(o);
export const setPrototypeOf = (o, proto = null) => requireObject(o) && Object.setPrototypeOf(o, proto);
export const defineProperties = (o, props = {}) => requireObject(o) && Object.defineProperties(o, props);
...
export const getOwnPropertyDescriptor = (o, prop) => Object.getOwnPropertyDescriptor(o, prop);
...
export const types = {
  ...
  isMapIterator: o => isPrototypeOf(MapIteratorPrototype, o),
  isSetIterator: o => isPrototypeOf(SetIteratorPrototype, o),
...
export function modifier(...args) {
  ...
  return define(fn => fn(get(), set), { get, set });
}
...
export function gettersetter(target, ...extraArgs) {
  ...
  if(Array.isArray(target)) {
    ...
    else r = (...args) => (args.length <= (target.get.length ?? 1) ? target.get(...args) : target.set(...args));
  } else if(isObject(target)) {
    r = (...args) => {
...
export function getMethodNames(obj, depth = 1, start = 0) {
  const r = [];
  for(const n of keys(obj, start, start + depth)) {
    try {
      if(isFunction(obj[n])) r.push(n);
    } catch(e) {}
  }
  return r;
}
...
export function isNumeric(value) {
  for(const f of [v => +v, parseInt, parseFloat]) if(!isNaN(f(value))) return true;
  return false;
}
