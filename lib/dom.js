...
export class Interface {
  ...
  querySelectorAll(...selectors) {
    ...
    return query(node, selectors, p => applyPath(p, this));
  }
}
...
export class Element extends Node {
  ...
  setAttribute(name, value) {
    if(!(typeof value == 'string' || (value !== null && value !== undefined && value.toString)))
      throw new TypeError(`Element.setAttribute(): value not of type 'string': ${value}`);
