...
export class Interface {
  ...
  appendChild(node) {
    let owner;
    if((owner = ownerElements(node))) if (isInstanceOf(Element, owner)) owner.removeChild(node);
  ...
  replaceChild(newChild, oldChild) {
    let owner;
    if((owner = ownerElements(newChild))) if (isInstanceOf(Element, owner)) owner.removeChild(newChild);
