...
import { inspect, isObject, define, quote, range, assert, memoize, getset, modifier, gettersetter, arrayFacade } from './util.js';
import readXML from './xml/read.js';
import { parseSelector } from './css3-selectors.js';
...
export class Node {
  ...
  querySelector(str) {
    ...
    let result = deep.find(node, selector, deep.RETURN_PATH);
    console.log('result =', result);

    return result ? applyPath(result, this) : result;
  }
