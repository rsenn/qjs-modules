  ...
  const obj = new Proxy(this, {
    get: (target, prop, receiver) => {
      ...
      if(isString(prop)) {
        ...
        //if(adapter.has(prop)) return new Attr([(...args) => getset(prop, ...args), prop], obj);
...
export class Element extends Node {
  ...
  const delegate = gettersetter(raw);

    return Factory.for(this).NamedNodeMap.cache(delegate, this);
  }
