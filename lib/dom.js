...
function setParentOwner(obj, parentOrOwner) {
  const isNode = isObject(parentOrOwner) && 'nodeType' in parentOrOwner;

  if(!isNode || parentOrOwner == null) parentNodes(obj, parentOrOwner);
  if(isNode || parentOrOwner == null) ownerElements(obj, parentOrOwner);
}
