...
export class Interface {
  ...
  appendChild(node) {
    if(isInstanceOf(Element, node?.parentNode)) node.parentNode.removeChild(node);
  ...
  replaceChild(newChild, oldChild) {
    if(isInstanceOf(Element, newChild?.parentNode)) newChild.parentNode.removeChild(newChild);
