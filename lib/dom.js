...
import { camelize, decamelize, isObject, define, quote, range, assert, memoize, getset, modifier, gettersetter, arrayFacade, lazyProperties } from 'util';
...
export class Serializer {
  serializeToString(node) {
    let str = writeXML(Node.raw(node) ?? node);
...
export class CSSStyleDeclaration {
  constructor(attrObj, owner) {
    ...
    ownerElement.set(cssStyle, owner);
