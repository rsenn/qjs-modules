...
import { define, isObject, isFunction, extendArray, getClassName } from './util.js';
...
export function buildXPath(ptr, root) {
  ...
  function NodeType(node) {
    return isObject(node) ? ('length' in node && typeof node.length == 'number' ? 'array' : getClassName(node).toLowerCase()) : typeof node;
  }
