...
export const ECMAScriptRules = /*enumerable*/ {
  shebang: /^\s*#\s*![^\n]*\n/,
  ...
  templateLiteralHead: /<INITIAL,NOREGEX,NESTED>`{TemplateElement}*\${/,
  templateLiteralPart: /<TEMPLATE>{TemplateElement}*\${/,
  templateLiteralTail: /<TEMPLATE>{TemplateElement}*`/,
  punctuator:
...
export class ECMAScriptLexer extends Lexer {
  ...
  addRules() {
    for(const name of Object.getOwnPropertyNames(ECMAScriptRules)) this.addRule(name, ECMAScriptRules[name]);
  }
}
