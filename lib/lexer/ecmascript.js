...
export const ECMAScriptRules = [
  ...
  ['templateLiteralHead', /<INITIAL,NOREGEX,NESTED>`{TemplateElement}*\${/, () => this.pushState('TEMPLATE')],
  ['templateLiteralPart', /<TEMPLATE>{TemplateElement}*\${/],
  ['templateLiteralTail', /<TEMPLATE>{TemplateElement}*`/, () => this.popState()],
  [
    'punctuator',
