import { watch, define, error } from './util.js';
import { inotify_event_size, IN_ACCESS, IN_ALL_EVENTS, IN_ATTRIB, IN_CLOSE, IN_CLOSE_NOWRITE, IN_CLOSE_WRITE, IN_CREATE, IN_DELETE, IN_DELETE_SELF, IN_DONT_FOLLOW, IN_EXCL_UNLINK, IN_IGNORED, IN_ISDIR, IN_MASK_ADD, IN_MODIFY, IN_MOVE, IN_MOVED_FROM, IN_MOVED_TO, IN_MOVE_SELF, IN_ONESHOT, IN_ONLYDIR, IN_OPEN, IN_Q_OVERFLOW, IN_UNMOUNT, IN_NONBLOCK } from './misc.js';
export {
  IN_ACCESS,
  IN_ALL_EVENTS,
  IN_ATTRIB,
...
export class inotify {
  ...
  constructor(flags = IN_NONBLOCK) {
    ...
    os.setReadHandler(this.fd, () => {
      let r = os.read(this.fd, buf, bytes, buf.byteLength - bytes);
