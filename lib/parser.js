...
extend(Rule.prototype, { [Symbol.operatorSet]: Operators.create({}), [Symbol.toStringTag]: 'Rule' });
...
extend(Terminal.prototype, { id: null, name: null, [Symbol.operatorSet]: Operators.create({}), [Symbol.toStringTag]: 'Terminal', id: null, name: null });
...
extend(OneOrMore.prototype, { [Symbol.operatorSet]: Operators.create({}), [Symbol.toStringTag]: 'OneOrMore' });
  ...
  match(lexer) {
    return Rule.match(lexer, lex => {
      for(let id of this.ids) {
        if(typeof id == 'string') id = lex.tokens.indexOf(id);
        else if(typeof id == 'object' && id !== null && !isNaN(+id)) id = +id;

        if(lex.next() != id) return false;
      }
