...
import { define, nonenumerable, declare } from './util.js';
...
define(Terminal.prototype, { id: null, name: null, [Symbol.operatorSet]: Operators.create({}), [Symbol.toStringTag]: 'Terminal', id: null, name: null });
...
define(OneOrMore.prototype, { [Symbol.operatorSet]: Operators.create({}), [Symbol.toStringTag]: 'OneOrMore' });
