...
export function properties(obj, opts = { enumerable: true }) {
  let desc = {};
...
export const getClassName = obj =>
  isObject(obj) ? ('constructor' in obj && obj.constructor.name) || obj[Symbol.toStringTag] : undefined;
  ...
  return (
    {
      object() {
        ...
        if('constructor' in value)
          name =
            value.constructor.name ?? (value.constructor + '').replace(/^\s*function\s*/g, '').replace(/\(.*/g, '');
