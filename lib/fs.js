...
export class Stats {
  ...
  /* prettier-ignore */ isDirectory() { return !!(this.mode & S_IFDIR); }
  /* prettier-ignore */ isCharacterDevice() { return !!(this.mode & S_IFCHR); }
  /* prettier-ignore */ isBlockDevice() { return !!(this.mode & S_IFBLK); }
  /* prettier-ignore */ isFile() { return !!(this.mode & S_IFREG); }
  /* prettier-ignore */ isFIFO() { return !!(this.mode & S_IFIFO); }
  /* prettier-ignore */ isSymbolicLink() { return !!(this.mode & S_IFLNK); }
  /* prettier-ignore */ isSocket() { return !!(this.mode & S_IFSOCK); }
}
