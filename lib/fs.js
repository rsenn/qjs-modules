...
import { access as sys_access } from 'misc';
import { error as sys_error } from 'misc';
import { fchmod as sys_fchmod } from 'misc';
import { fchown as sys_fchown } from 'misc';
import { fdatasync as sys_fdatasync } from 'misc';
import { fstat as sys_fstat } from 'misc';
import { fsync as sys_fsync } from 'misc';
import { ftruncate as sys_ftruncate } from 'misc';
import { futimes as sys_futimes } from 'misc';
...
import { link as sys_link } from 'misc';
import { mkstemp } from 'misc';
import { symlink as sys_symlink } from 'misc';
import { tempnam } from 'misc';
import { toArrayBuffer } from 'misc';
import { toString } from 'misc';
import { watch } from 'misc';
import { filename } from 'mmap';
...
export function createReadStream(path, options = { encoding: 'utf8' }) {
  ...
  const file = std.open(path, flags + 'b', err);
