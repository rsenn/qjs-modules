...
const filenameStack = new Stack(value => (require.filename = value),
  () => require.filename
);
const exportsStack = new Stack(value => (globalThis.exports = value),
  () => globalThis.exports
);
const moduleStack = new Stack(value => (
    (globalThis.module = value),
    value?.exports ? (globalThis.exports = value.exports) : delete globalThis.exports
  ),
  () => globalThis.module
);
if(scriptArgs[0]) {
  filenameStack.push(scriptArgs[0]);
}
...
class CJSModule {
  ...
  load() {
    ...
    //const _mark = '##SCRIPT##';
    let _loaderTemplate = _mark =>
      `(function _loader (exports, require, module) {${_mark}})(ctx.exports, _require, ctx);`;
    ...
    get(target, prop, receiver) {
      ...
      return function(...args) {
        ...
        if(typeof module[prop] != 'function')
          throw new Error(`Module '${m}' method '${prop}' not a function`);
...
function lookupModule(m) {
  ...
  if(statPath(`${m}/package.json`).isFile) {
    ...
    if(pkg &&
      Object.keys(pkg).indexOf('main') !== -1 &&
      pkg.main !== '' &&
      statPath(`${m}/${pkg.main}`).isFile
    ) {
      tryOthers = false;
