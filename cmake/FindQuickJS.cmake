...
function(make_module FNAME)
  ...
  set_target_properties(${TARGET_NAME} PROPERTIES PREFIX "" RPATH "${OPENCV_LIBRARY_DIRS}:${QUICKJS_PREFIX}/lib:${QUICKJS_PREFIX}/lib/quickjs" OUTPUT_NAME "${VNAME}" BUILD_RPATH "${CMAKE_BINARY_DIR}:${CMAKE_CURRENT_BINARY_DIR}:${CMAKE_BINARY_DIR}/quickjs:${CMAKE_CURRENT_BINARY_DIR}/quickjs" COMPILE_FLAGS "${MODULE_COMPILE_FLAGS}")
...
function(compile_module SOURCE)
  ...
  add_custom_command(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${BASE}.c
    COMMAND sh -x -c "qjsc -v -c -o ${CMAKE_CURRENT_BINARY_DIR}/${BASE}.c -m ${CMAKE_CURRENT_SOURCE_DIR}/${SOURCE}"
    DEPENDS  ${CMAKE_CURRENT_SOURCE_DIR}/${SOURCE} WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMENT "Generate ${BASE}.c from ${SOURCE} using qjs compiler" SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/${SOURCE})
