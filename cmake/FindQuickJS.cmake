macro(find_quickjs)
  ...
  if(NOT QUICKJS_INCLUDE_DIRS)
    set(QUICKJS_INCLUDE_DIRS "${QUICKJS_INCLUDE_DIR}"
        CACHE STRING "QuickJS include directories")
  endif()

  if(QUICKJS_MODULE_DIR)
    set(QUICKJS_MODULE_DIR "${QUICKJS_MODULE_DIR}"
        CACHE STRING "QuickJS module directory")
  endif()
  ...
  message(STATUS "\tinstall directory\t ${QUICKJS_INSTALL_PREFIX}")
