...
- **`BUGS.md`** — bugs found *incidentally* while doing other work (e.g. while writing unit
  tests) and deliberately left unfixed at the time. Each entry names the file/function, the
  concrete failure, and how to reproduce it. Add to this file when you find a bug but the task
  at hand isn't "fix bugs" — don't fix it out of scope, but don't lose it either.
